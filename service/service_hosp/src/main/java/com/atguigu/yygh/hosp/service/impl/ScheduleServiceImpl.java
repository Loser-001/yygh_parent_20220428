...
//        Schedule schedule = baseMapper.selectById(scheduleId);
    ...
    public Map<String, Object> getBookingScheduleRule(Integer page, Integer limit, String hoscode, String depcode) {
        ...
        //医院名称
        baseMap.put("hosname", hospitalService.getByHosName(hoscode));
        //科室
    ...
    private IPage getListDate(Integer page, Integer limit, BookingRule bookingRule) {
        ...
        //如果当天放号时间已经过去了，预约周期从皇后一天开始计算，周期+1
    ...
    public List<Schedule> getDetailSchedule(String hoscode, String depcode, String workDate) {
      ...
      //把得到的list集合进行遍历，向设置值其他值：医院名称、科室名称、日期对应的星期
        scheduleList.stream().forEach(item -> {
            this.packageSchedule(item);
        });
      return scheduleList;
    }
    //封装排班详情其他值  医院名称、科室名称、日期对应的星期
    private Schedule packageSchedule(Schedule schedule) {
        //设置医院名称
        schedule.getParam().put("hosname",hospitalService.getByHosName(schedule.getHoscode()));
        //设置科室名称
    ...
    public Map<String, Object> getRuleSchedule(long page, long limit, String hoscode, String depcode) {
        ...
        //获取医院名称
        String hosName = hospitalService.getByHosName(hoscode);
        //其它基础结构
        Map<String,String> baseMap = new HashMap<>();
